...
<script type="text/javascript" src="js/rightde.js"></script>
<title>The National Hospital of Sri Lanka</title>
</head>
...
<h1 class="text-center ">NHSL<br /><small style="font-size:20px">Hospital Management System</small></h1>
</div>
</div>
</div>
<br />
...
<div class="col-md-4 col-md-push-2  col-xs-12 ">
	...
	<center>
	<img id="log" src="images/log.jpg" class="img-responsive" />
	<br>
	...
	<div style="font-size :18px; border-style: none  none none dotted; border-width: 2px; border-color: rgba(0, 0, 0, 0.2); height: 390px;text-align: justify;" class="col-md-4 col-md-push-2  col-xs-12 "><br>This is the main system login form used to log into the system. You can enter Super and Basic admin login information. If you are not a system member, create your login access by using <a target="_blank" style="font-colour="Blue"" href='superadmin.php'>Register Here</a>
<br>
	<br>Enter the login information provided by the Hospital Administration. </div>
	</div>
...
Copyright © The National Hospital of Sri Lanka 2022. All rights reserved.
        </div>
    </div>
    </div>
	</footer>
