...
<div class="container">
<div class="row">
<div class="col-md-4 col-md-push-4 col-xs-12 alert alert-success text-center">Patients who register on this forum have direct access to the hospital's out-patient department and doctors.</div>
</div>
</div>
...
('<?php echo $emlduperr; ?>');</script></td>
  ...
  <tr>
    ...
    <tr>
     <td colspan="2"  style="padding:5px;" >Birthday<div class="input-group col-md-12 col-xs-12"><input name="smbdd" required  type="date" class="form-control" placeholder="Birthday"></div></td>
  </tr>
