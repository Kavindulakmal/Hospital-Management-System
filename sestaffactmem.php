...
<h3 style="font-family:calibri;" class="text-center">Search for Staff Information</h3></div>
</div>
...
<dt style="font-size:12px;"><strong>Birthday      : </strong></dt>
...
<dt style="font-size:12px;"><strong>Member Type: </strong></dt></dt>
<dd style="font-size:12px;"><?php echo $row["smtype"]; ?></dd>

<dt style="font-size:12px;"><strong>Member Working Time: </strong></dt></dt>
