...
<h1 class="text-center ">NHSL<br /><small style="font-size:20px">Hospital Management System</small></h1></div>
...
<div class="alert alert-info">By clicking<img  width="32px" src="images/info.png"> can obtain information about admitted patients.</div>
</div>
</div>
</div>
<center>
...
<div class="row">
<div class="col-md-6 col-md-push-3 col-xs-12">
<div class="alert alert-info">By clicking Doctor Info, you can get more information about the doctor, by clicking Patient Info, you can get more information about the admitted patient, by clicking Update Room Information, you can update room information.</div>
</div>
</div>
</div>
  ...
  <tr valign="middle">
      ...
      <td  align="center"><a href="roomup.php?id=<?php echo $row["room_id"]; ?>" name="ad">Update Room Information</a></td>
