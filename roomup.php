...
<h3 style="font-family:calibri;" class="text-center">Update Room Details </h3></div>
<br />
<div class="container">
<div class="row">
<div class="col-md-4 col-md-push-4 col-xs-12 alert alert-success text-center">For Check the room, select Doctor.</div>
</div>
</div>
